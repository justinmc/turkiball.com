...
function head($where)
{
   ...
   echo "<!-- CSS link -->\n";
   echo "<link rel = 'stylesheet' type = \"text/css\" href = \"http://www.turkiball.com/stylefeed.css\">\n\n";
...
function newsbar($where)
{
   ...
   echo "   <div class = \"news\">\n";
   echo "      <ul class = \"newslink\"><li" . $feed . "><a href = \"http://www.turkiball.com/feed\">The Feed</a></ul>\n";
   echo "      <br><br><br>\n";
